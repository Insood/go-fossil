...
- Scoring: accepted artifact regions create valued fragments above the configured pixel minimum; total score increases only after those fragments reach the charging pad
