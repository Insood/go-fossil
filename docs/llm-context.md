...
- `LaserSystem` maps held left-click input inside the drone viewport to a terrain-sampled target point for the player drone's `Laser` component and stamps the chunk burn overlay at that point.
