...
- `UserInterfaceSystem` draws total score, the labelled drone battery bar, the drone viewport, the reticle, and recent collected-fragment thumbnails with weight and score.
